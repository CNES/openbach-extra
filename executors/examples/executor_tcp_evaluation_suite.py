...
def main(argv=None):
    ...
    print(observer.args)
    print(path)
    path = "/home/ubuntu/tcp_eval_suite_files/"
            ...
            if path.split('.',1)[1] == "csv":
                ...
                with tempfile.TemporaryFile(suffix='.png') as tmp_figure:
                    with tarfile.open(fileobj=path, mode='w:gz') as tar:
                        tar.add(tmp_figure)
        plt.savefig("/home/ubuntu/tcp_eval_suite_files/plot_test_ts.png") #to_change
        ...
        if path is None:
            ...
            if path.split('.',1)[1] == "csv":
                ...
                with tempfile.TemporaryFile(suffix='.png') as tmp_figure:
                    with tarfile.open(fileobj=path, mode='w:gz') as tar:
                        tar.add(tmp_figure)
        plt.savefig("/home/ubuntu/tcp_eval_suite_files/plot_test_cdf.png") #to_change
   """
