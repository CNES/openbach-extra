...
def main(target_address, log_address, dest_path, granularity, traffic_type = 'UDP', 
    ...
    for line in stats:
        ...
        statistics = {'bitrate receiver (bps)': bitrate}
    ...
    for line in stats:
        ...
        bitrate = txt[1]
        bitrate = float(bitrate)*1024
        statistics = {'bitrate sender (bps)': bitrate}
        collect_agent.send_stat(timestamp, **statistics)
...
if __name__ == "__main__":
    ...
    main(target_address, sender_address, dest_path, granularity, traffic_type, packet_size, packet_rate, bandwidth, duration, data_size, meter)
