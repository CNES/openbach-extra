...
"""This scenario launches the *ftp_rate* scenario
from /openbach-extra/apis/scenario_builder/scenarios/
"""


from auditorium_scripts.scenario_observer import ScenarioObserver
from scenario_builder.scenarios import ftp_rate


def main(scenario_name='generate_ftp_rate', argv=None):
